...
import com.techullurgy.gameengine.Camera
import com.techullurgy.gameengine.SceneRenderer
import com.techullurgy.gameengine.Shader
...
class Square(
    ...
    fun draw() {
        ...
        shader.bind()
        shader.enableAttributeLocation(
            "vPosition",
            getCoordinates(),
            COORDS_PER_VERTEX,
            vertexStride
...
private fun getSquareCoordinatesFor(
    left: Float,
    top: Float,
    right: Float,
    bottom: Float
